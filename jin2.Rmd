...
Overview
========================================================
This presentation contains documentation for the Diamond price prediction application. The application can be found [**here**] (https://kjw101489.shinyapps.io/jinjin/)
...
Both files can be found here: [GitHub repo](https://github.com/kjw101489/Course-Project-Shiny-Application-and-Reproducible-Pitch-..git)
reference : avkch 
